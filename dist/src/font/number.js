...
var NUMBER = {
  "0": (0, _util.generateFontData)(660, 270, 360, 0, 0, 0, 0, [{
    d: 1,
    v: [["m", 270, 180, {
  ...
  "1": (0, _util.generateFontData)(380, 76, 352, 15, 15, 0, 0, [{
    d: -1,
    v: [["m", 0, 51, {
      x: -2,
      y: 2,
      r: (0, _util.getR)(0, 51, 76 - _util.VERTEX_GAP, 0)
    }], ["l", 76 - _util.VERTEX_GAP, 0, {
      r: _util.ROTATE_HORIZONTAL,
      p: 1
    }], ["l", 76, 0, {
      r: _util.ROTATE_HORIZONTAL,
  ...
  "2": (0, _util.generateFontData)(580, 210, 356, 0, 0, 2, 2, [{
    d: -1,
    v: [["m", 3.9, 68.8, {
      x: 1.2,
      y: 1.2,
      r: (0, _util.getCurveR)(3.9, 68.8, 16.7, 29, 54.2, 3.1, 98.2, 0.2, 0)
    }], ["b", 16.7, 29, 54.2, 3.1, 98.2, 0.2], ["b", 151.8, -3.3, 208.5, 38.3, 198.9, 100.1], ["b", 197.1, 111.8, 196.4, 142.4, 101.5, 235.2], ["b", 11.4, 323.2, 0, 356 - _util.VERTEX_GAP, 0, 356 - _util.VERTEX_GAP, {
      r: _util.ROTATE_NONE
    }], ["l", 0, 356 - _util.VERTEX_GAP, {
      r: _util.ROTATE_VERTICAL,
      p: 1
    }], ["l", 0, 356, {
      r: _util.ROTATE_VERTICAL,
  ...
  "3": (0, _util.generateFontData)(580, 222.1, 360, 0, 0, 0, 0, [{
    d: -1,
    v: [["m", 10.7, 66.3, {
      r: (0, _util.getCurveR)(10.7, 66.3, 11.2, 64.8, 11.7, 63.3, 12.3, 61.8, 0)
  ...
  "4": (0, _util.generateFontData)(596, 236, 352, 0, 0, 0, 0, [{
    d: 1,
    v: [["m", 175, 352, {
      y: 0,
      f: 1
      ...
      f: 1
    }], ["l", 175 - _util.VERTEX_GAP, 0, {
      r: _util.ROTATE_VERTICAL,
      p: 1,
      v: 1
    }], ["l", 0, 276 - _util.VERTEX_GAP, {
      r: _util.ROTATE_HORIZONTAL,
      p: 1
    }], ["l", 0, 276, {
      r: _util.ROTATE_VERTICAL,
  ...
  "5": (0, _util.generateFontData)(596, 208.5, 356, 0, -5, -2, -2, [{
    d: 1,
    v: [["m", 0, 295.7, {
      r: (0, _util.getCurveR)(0, 295.7, 15.3, 333.8, 52.2, 356.2, 97.5, 356, 0),
      f: 1
  ...
  "6": (0, _util.generateFontData)(596, 215.8, 360, 0, -2, 0, 0, [{
    d: 1,
    v: [["m", 7.6, 272.3, {
      r: _util.ROTATE_HORIZONTAL,
      p: 1,
  ...
  "7": (0, _util.generateFontData)(540, 213, 352, 0, 0, 0, 0, [{
    d: -1,
    v: [["m", 0, 0, {
      x: 0,
      r: _util.ROTATE_VERTICAL
  ...
  "8": (0, _util.generateFontData)(596, 224, 360, 0, 0, 0, 0, [{
    d: 1,
    v: [["m", 112, 180, {
      r: _util.ROTATE_HORIZONTAL,
      p: 1,
  ...
  "9": (0, _util.generateFontData)(596, 215.8, 360, 0, -2, 0, 0, [{
    d: -1,
    v: [["m", 208.2, 88, {
      r: _util.ROTATE_HORIZONTAL,
      p: 1,
